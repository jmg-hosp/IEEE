...
#LF<-matrix(c(BS0, BS1, BS2, BS3, TS0, TS1, TS2, TS3), nrow=7, ncol=8,
#                                  dimnames=list(1 : 7, c("BS0", "BS1", "BS2", "BS3","TS0", "TS1", "TS2", "TS3")))
                
#friedman.test(LF)
RR<-c(BS0, TS0)
todo<-gl(2,14, labels=c("BS0", "TS0"))
pairwise.wilcox.test(RR,todo, paired = TRUE, p.adjust.method ="bonferroni")
