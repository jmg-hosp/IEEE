...
for(i in 1:lstc) {
  z<-x[i]
  archivo_ND<-paste("/home/jose/Octave_programas_Doctorado_ultimo_total/Risk_Doctorado_Procesar/Seniales/Validacion_BS_mat/CRC_",z,"_STC-BS.mat",sep="")
...
for(i in 1:l) {
  z<-x[i]
  archivo_ND<-paste("/home/jose/Octave_programas_Doctorado_ultimo_total/Risk_Doctorado_Procesar/Seniales/Validacion_BS_mat/CRC_",z,"_STA-BS.mat",sep="")
...
for(i in 1:l) {
  z<-x[i]
  archivo_ND<-paste("/home/jose/Octave_programas_Doctorado_ultimo_total/Risk_Doctorado_Procesar/Seniales/Validacion_BS_mat/CRC_",z,"_STP-BS.mat",sep="")
...
for(i in 1:l) {
  z<-x[i]
  archivo_ND<-paste("/home/jose/Octave_programas_Doctorado_ultimo_total/Risk_Doctorado_Procesar/Seniales/Validacion_BS_mat/CRC_",z,"_STB-BS.mat",sep="")
...
for(i in 1:lsuc) {
  z<-x[i]
  archivo_ND<-paste("/home/jose/Octave_programas_Doctorado_ultimo_total/Risk_Doctorado_Procesar/Seniales/Validacion_BS_mat/CRC_",z,"_SUC-BS.mat",sep="")
...
for(i in 1:l) {
  z<-x[i]
  archivo_ND<-paste("/home/jose/Octave_programas_Doctorado_ultimo_total/Risk_Doctorado_Procesar/Seniales/Validacion_BS_mat/CRC_",z,"_SUA-BS.mat",sep="")
...
for(i in 1:l) {
  z<-x[i]
  archivo_ND<-paste("/home/jose/Octave_programas_Doctorado_ultimo_total/Risk_Doctorado_Procesar/Seniales/Validacion_BS_mat/CRC_",z,"_SUP-BS.mat",sep="")
...
for(i in 1:l) {
  z<-x[i]
  archivo_ND<-paste("/home/jose/Octave_programas_Doctorado_ultimo_total/Risk_Doctorado_Procesar/Seniales/Validacion_BS_mat/CRC_",z,"_SUB-BS.mat",sep="")
...
# print(primero)
# print(tercero)
wilcox.test(CRC_STC_BS_CDOWN, CRC_STB_BS_CDOWN, paired = TRUE)
